    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reportButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(AdminPanel.this, "Describe your pdf Report", Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.activity_login:
                ...
                break;
            default:
                Toast.makeText(AdminPanel.this,"No Activity selected",Toast.LENGTH_LONG).show();
        }
...
////
    ...
    {
        progressDoalog = new ProgressDialog(AdminPanel.this);
        progressDoalog.setMax(100);
        progressDoalog.setMessage("loading....");
        progressDoalog.setTitle("My Report");
